...
public class TSalesRecord extends UpdatableRecordImpl<TSalesRecord> implements Record9<Integer, String, Integer, String, BigDecimal, Timestamp, String, byte[], String> {

    private static final long serialVersionUID = 1233164450;
     ...
     */
    @Override
    public Row9<Integer, String, Integer, String, BigDecimal, Timestamp, String, byte[], String> fieldsRow() {
     ...
     */
    @Override
    public Row9<Integer, String, Integer, String, BigDecimal, Timestamp, String, byte[], String> valuesRow() {
     ...
     */
    @Override
    public TSalesRecord values(Integer value1, String value2, Integer value3, String value4, BigDecimal value5, Timestamp value6, String value7, byte[] value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TSalesRecord(Integer pk, String trader, Integer fkCamp, String provider, BigDecimal cash, Timestamp buydate, String recipenumber, byte[] recipeshot, String recipenote) {
        super(TSales.T_SALES);
