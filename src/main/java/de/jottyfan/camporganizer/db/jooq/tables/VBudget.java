...
public class VBudget extends TableImpl<VBudgetRecord> {
    ...
    private static final long serialVersionUID = 175555619;
    ...
    private VBudget(String alias, Table<VBudgetRecord> aliased) {
        this(alias, aliased, null);
    }

    private VBudget(String alias, Table<VBudgetRecord> aliased, Field<?>[] parameters) {
