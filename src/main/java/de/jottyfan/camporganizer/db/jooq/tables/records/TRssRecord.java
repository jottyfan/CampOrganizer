...
public class TRssRecord extends UpdatableRecordImpl<TRssRecord> implements Record4<String, Timestamp, String, Integer> {

    private static final long serialVersionUID = 2102082027;
