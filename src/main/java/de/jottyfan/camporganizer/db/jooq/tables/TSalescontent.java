...
public class TSalescontent extends TableImpl<TSalescontentRecord> {
    ...
    private static final long serialVersionUID = -1769352150;
    ...
    private TSalescontent(String alias, Table<TSalescontentRecord> aliased) {
        this(alias, aliased, null);
    }

    private TSalescontent(String alias, Table<TSalescontentRecord> aliased, Field<?>[] parameters) {
