...
public class TProfilerole extends TableImpl<TProfileroleRecord> {
    ...
    private static final long serialVersionUID = -679333125;
    ...
    private TProfilerole(String alias, Table<TProfileroleRecord> aliased) {
        this(alias, aliased, null);
    }

    private TProfilerole(String alias, Table<TProfileroleRecord> aliased, Field<?>[] parameters) {
