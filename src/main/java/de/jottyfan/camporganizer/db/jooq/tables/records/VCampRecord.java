...
public class VCampRecord extends TableRecordImpl<VCampRecord> implements Record12<Integer, Boolean, String, Timestamp, Timestamp, Double, String, Integer, Integer, String, String, String> {

    private static final long serialVersionUID = -1889917081;
     ...
     */
    @Override
    public Row12<Integer, Boolean, String, Timestamp, Timestamp, Double, String, Integer, Integer, String, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row12<Integer, Boolean, String, Timestamp, Timestamp, Double, String, Integer, Integer, String, String, String> valuesRow() {
     ...
     */
    @Override
    public VCampRecord values(Integer value1, Boolean value2, String value3, Timestamp value4, Timestamp value5, Double value6, String value7, Integer value8, Integer value9, String value10, String value11, String value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public VCampRecord(Integer pk, Boolean isOver, String name, Timestamp arrive, Timestamp depart, Double year, String locationName, Integer minAge, Integer maxAge, String url, String price, String countries) {
        super(VCamp.V_CAMP);
