...
public class TSalescontenttype extends TableImpl<TSalescontenttypeRecord> {
    ...
    private static final long serialVersionUID = 1653210119;
    ...
    private TSalescontenttype(String alias, Table<TSalescontenttypeRecord> aliased) {
        this(alias, aliased, null);
    }

    private TSalescontenttype(String alias, Table<TSalescontenttypeRecord> aliased, Field<?>[] parameters) {
