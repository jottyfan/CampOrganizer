...
public class VRegistration extends TableImpl<VRegistrationRecord> {
    ...
    private static final long serialVersionUID = -1774850063;
    ...
    private VRegistration(String alias, Table<VRegistrationRecord> aliased) {
        this(alias, aliased, null);
    }

    private VRegistration(String alias, Table<VRegistrationRecord> aliased, Field<?>[] parameters) {
