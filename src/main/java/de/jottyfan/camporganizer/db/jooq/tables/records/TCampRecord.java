...
public class TCampRecord extends UpdatableRecordImpl<TCampRecord> implements Record9<Integer, String, Timestamp, Timestamp, Integer, Integer, Integer, String, String> {

    private static final long serialVersionUID = 1552816924;
     ...
     */
    @Override
    public Row9<Integer, String, Timestamp, Timestamp, Integer, Integer, Integer, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row9<Integer, String, Timestamp, Timestamp, Integer, Integer, Integer, String, String> valuesRow() {
     ...
     */
    @Override
    public TCampRecord values(Integer value1, String value2, Timestamp value3, Timestamp value4, Integer value5, Integer value6, Integer value7, String value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TCampRecord(Integer pk, String name, Timestamp arrive, Timestamp depart, Integer fkLocation, Integer minAge, Integer maxAge, String price, String countries) {
        super(TCamp.T_CAMP);
