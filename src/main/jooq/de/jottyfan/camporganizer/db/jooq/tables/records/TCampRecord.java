...
public class TCampRecord extends TableRecordImpl<TCampRecord> implements Record11<Integer, String, Timestamp, Timestamp, Integer, Integer, Integer, String, String, Integer, Boolean> {

    private static final long serialVersionUID = 2051616312;
     ...
     */
    @Override
    public Row11<Integer, String, Timestamp, Timestamp, Integer, Integer, Integer, String, String, Integer, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row11<Integer, String, Timestamp, Timestamp, Integer, Integer, Integer, String, String, Integer, Boolean> valuesRow() {
     ...
     */
    @Override
    public TCampRecord values(Integer value1, String value2, Timestamp value3, Timestamp value4, Integer value5, Integer value6, Integer value7, String value8, String value9, Integer value10, Boolean value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TCampRecord(Integer pk, String name, Timestamp arrive, Timestamp depart, Integer fkLocation, Integer minAge, Integer maxAge, String price, String countries, Integer fkDocument, Boolean lockSales) {
        super(TCamp.T_CAMP);
