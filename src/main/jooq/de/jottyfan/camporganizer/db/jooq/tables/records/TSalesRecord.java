...
public class TSalesRecord extends TableRecordImpl<TSalesRecord> implements Record10<Integer, String, Integer, String, BigDecimal, Timestamp, String, byte[], String, String> {

    private static final long serialVersionUID = -1640738512;
