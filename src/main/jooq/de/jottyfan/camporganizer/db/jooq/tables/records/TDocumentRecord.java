...
public class TDocumentRecord extends TableRecordImpl<TDocumentRecord> implements Record5<Integer, EnumDocument, String, String, EnumFiletype> {

    private static final long serialVersionUID = 417988913;
